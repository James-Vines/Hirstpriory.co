...
<div id="page" class="hfeed site">
	...
	<div class="landing-header" style="background-image: url('<?php bloginfo('stylesheet_directory'); ?>/images/woodland-wedding-bg.png');">
	</div>
	<div class="alert alert-danger landing-alert">
  	<div class="container text-center">
    	<div class="row">
      	...
      	<div class="col-md-3 col-sm-6 contact"><i class="fa fa-envelope contact-image" aria-hidden="true"></i>&nbsp&nbsp<a href="mailto:info@hirstpriory.co.uk" class="post_link">info@hirstpriory.co.uk</a></div>
