...
function rootstrap_widgets_init() {
	...
	register_sidebar(array(
    	'id' => 'home-widget-1',
    	'name' => __( 'Homepage Bottom Widget', 'rootstrap' ),
    	'description' => __( 'Displays on the bottom of the Home Page', 'rootstrap' ),
    ...
    register_sidebar(array(
      'id' => 'home-widget-2',
      'name' =>  __( 'Homepage Header Widget', 'rootstrap' ),
      'description' => __( 'Displays in the Home Page Header', 'rootstrap' ),
      'before_widget' => '<div id="%1$s" class="widget %2$s">',
      'after_widget' => '</div>',
      'before_title' => '<h3 class="widgettitle">',
      'after_title' => '</h3>',
    ...
    register_sidebar(array(
      'id' => 'home-widget-3',
      'name' =>  __( 'Bottom Left Widget (Wedding)', 'rootstrap' ),
      'description' =>  __( 'Displays bottom left of Page', 'rootstrap' ),
      'before_widget' => '<div id="%1$s" class="widget %2$s">',
      'after_widget' => '</div>',
      'before_title' => '<h3 class="widgettitle">',
      'after_title' => '</h3>',
    ...
    register_sidebar(array(
    	'id' => 'footer-widget-1',
    	'name' =>  __( 'Bottom Left Widget (Business)', 'rootstrap' ),
    	'description' =>  __( 'Displays bottom left of Page', 'rootstrap' ),
    	'before_widget' => '<div id="%1$s" class="widget %2$s">',
    	'after_widget' => '</div>',
    	'before_title' => '<h3 class="widgettitle">',
    ...
    register_sidebar(array(
    	'id' => 'footer-widget-2',
    	'name' =>  __( 'Bottom Right Widget (Facebook)', 'rootstrap' ),
    	'description' =>  __( 'Displays bottom right of Page', 'rootstrap' ),
    	'before_widget' => '<div id="%1$s" class="widget %2$s">',
    	'after_widget' => '</div>',
    	'before_title' => '<h3 class="widgettitle">',
    	'after_title' => '</h3>',
